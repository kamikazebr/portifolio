...
const icons = [Network, Brain, Lock, ShieldCheck];

export const ExpertiseSection = ({ dict }: ExpertiseSectionProps) => (
    <section id="expertise" className="container py-16 sm:py-20">
